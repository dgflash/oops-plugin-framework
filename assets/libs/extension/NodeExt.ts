...
if (!EDITOR_NOT_IN_PREVIEW) {
    ...
    Object.defineProperty(Node.prototype, 'size', {
        ...
        set: function (value: Size) {
            const self: Node = this;
            const uiTransform = self.getComponent(UITransform) || self.addComponent(UITransform);
    ...
    Object.defineProperty(Node.prototype, 'opacity', {
        get: function () {
            const self: Node = this;
            const op = self.getComponent(UIOpacity);
            if (op != null) {
                return op.opacity;
            }

            const render = self.getComponent(UIRenderer);
            if (render) {
